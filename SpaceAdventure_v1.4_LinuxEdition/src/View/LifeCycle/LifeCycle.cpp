...
void LifeCycle:: InitMedia()
{
    ...
    else
    {
        ...
        else
        {
            ...
            Xanadu = TTF_OpenFont("src/View/LifeCycle/Resources/Xanadu.ttf", 30);
...
{
    Intro.SetBackgroundTexture(LoadTexture("src/View/LifeCycle/Resources/background.png"));
    
    Intro.SetForwardButtonTexture(LoadTexture("src/View/LifeCycle/Resources/right.png"));
    
    Intro.SetPushedForwardButtonTexture(LoadTexture("src/View/LifeCycle/Resources/rightPushed.png"));
    
    Intro.SetLogoTexture(LoadTexture("src/View/LifeCycle/Resources/logo.png"));
    
    Intro.SetInsertCreditTexture(LoadTexture("src/View/LifeCycle/Resources/insertCredit.png"));
    
    Intro.SetInsertCreditPushedTextre(LoadTexture("src/View/LifeCycle/Resources/insertCreditPushed.png"));
    
    Intro.SetLoadGameTexture(LoadTexture("src/View/LifeCycle/Resources/loadGame.png"));
    
    Intro.SetLoadGamePushedTexture(LoadTexture("src/View/LifeCycle/Resources/loadGamePushed.png"));
    
    Intro.SetFileNotFoundTexture(LoadTexture("src/View/LifeCycle/Resources/fileNotFound.png"));
    
    Intro.SetInfoTexture(LoadTexture("src/View/LifeCycle/Resources/infoButton.png"));
    
    Intro.SetInfoTexturePushed(LoadTexture("src/View/LifeCycle/Resources/infoButtonPushed.png"));
    
    Intro.SetPayTableTexture(LoadTexture("src/View/LifeCycle/Resources/payTable.png"));
    
    Intro.SetPayTableTexturePushed(LoadTexture("src/View/LifeCycle/Resources/payTablePushed.png"));
    
    Intro.SetVolumeTexture(LoadTexture("src/View/LifeCycle/Resources/volume.png"));
    
    Intro.SetVolumeTexture1(LoadTexture("src/View/LifeCycle/Resources/volume1.png"));
    
    Intro.SetVolumeTexture2(LoadTexture("src/View/LifeCycle/Resources/volume2.png"));
    
    Intro.SetVolumeTexture3(LoadTexture("src/View/LifeCycle/Resources/volume3.png"));
    
    Intro.SetVolumePlusButton(LoadTexture("src/View/LifeCycle/Resources/plusButton.png"));
    
    Intro.SetVolumePlusButtonPushed(LoadTexture("src/View/LifeCycle/Resources/plusButtonPushed.png"));
    
    Intro.SetVolumeMinusButton(LoadTexture("src/View/LifeCycle/Resources/minusButton.png"));
    
    Intro.SetVolumeMinusButtonPushed(LoadTexture("src/View/LifeCycle/Resources/minusButtonPushed.png"));

    Intro.SetSpaceShipTexture(LoadTexture("src/View/LifeCycle/Resources/spaceShip.png"));
    
    Intro.SetSpaceShipButtonPlus(LoadTexture("src/View/LifeCycle/Resources/spaceShipButtonPlus.png"));
    
    Intro.SetSpaceShipButtonPlusPushed(LoadTexture("src/View/LifeCycle/Resources/spaceShipButtonPlusPushed.png"));
    
    Intro.SetSpaceShipButtonMinus(LoadTexture("src/View/LifeCycle/Resources/spaceShipButtonMinus.png"));
    
    Intro.SetSpaceShipButtonMinusPushed(LoadTexture("src/View/LifeCycle/Resources/spaceShipButtonMinusPushed.png"));
    
    Intro.SetSpaceShipButtonOk(LoadTexture("src/View/LifeCycle/Resources/okButton.png"));
    
    Intro.SetSpaceShipButtonOkPushed(LoadTexture("src/View/LifeCycle/Resources/okButtonPushed.png"));
        
    Intro.SetRulesTexture(LoadTexture("src/View/LifeCycle/Resources/rules.png"));
        
    Intro.SetCloseRulesButton(LoadTexture("src/View/LifeCycle/Resources/closeButton.png"));
    
    Intro.SetClosePayTableButton(LoadTexture("src/View/LifeCycle/Resources/closeButton.png"));
    
    Intro.SetPayTableTextureInfo(LoadTexture("src/View/LifeCycle/Resources/figureWeight.png"));
...
{
    PayLines.SetBackButtonTexture(LoadTexture("src/View/LifeCycle/Resources/left.png"));
    
    PayLines.SetBackButtonTexturePushed(LoadTexture("src/View/LifeCycle/Resources/leftPushed.png"));
    
    PayLines.SetFirstRow(LoadTexture("src/View/LifeCycle/Resources/linesFirstLine.png"));
    
    PayLines.SetSecondRow(LoadTexture("src/View/LifeCycle/Resources/linesSecondLine.png"));
    
    PayLines.SetThirdRow(LoadTexture("src/View/LifeCycle/Resources/linesThirdLine.png"));
    
    PayLines.SetFourthRow(LoadTexture("src/View/LifeCycle/Resources/linesFourthLine.png"));
    
    PayLines.SetPlayButtonTexture(LoadTexture("src/View/LifeCycle/Resources/play.png"));
    
    PayLines.SetPlayButtonTexturePushed(LoadTexture("src/View/LifeCycle/Resources/playPushed.png"));
}
...
{
    Slot.SetSlotTexture(LoadTexture("src/View/LifeCycle/Resources/currentReel.png"));
    
    Slot.SetMinusButtonLines(LoadTexture("src/View/LifeCycle/Resources/minusReel.png"));
    
    Slot.SetPlusLinesButton(LoadTexture("src/View/LifeCycle/Resources/plusReel.png"));

    Slot.SetPlusLinesButtonPushed(LoadTexture("src/View/LifeCycle/Resources/plusReelPushed.png"));
    
    Slot.SetMinusButtonLinesPushed(LoadTexture("src/View/LifeCycle/Resources/minusReelPushed.png"));
    
    Slot.SetMinusButtonBet(LoadTexture("src/View/LifeCycle/Resources/minusReel.png"));
    
    Slot.SetMinusButtonBetPushed(LoadTexture("src/View/LifeCycle/Resources/minusReelPushed.png"));
    
    Slot.SetPlusButtonBet(LoadTexture("src/View/LifeCycle/Resources/plusReel.png"));
    
    Slot.SetPlusButtonBetPushed(LoadTexture("src/View/LifeCycle/Resources/plusReelPushed.png"));
    
    Slot.SetMaxBetButton(LoadTexture("src/View/LifeCycle/Resources/maxBet.png"));
    
    Slot.SetMaxBetButtonPushed(LoadTexture("src/View/LifeCycle/Resources/maxBetPushed.png"));
    
    Slot.SetStartSpinButton(LoadTexture("src/View/LifeCycle/Resources/startSpin1.png"));
    
    Slot.SetStartSpinButtonPushed(LoadTexture("src/View/LifeCycle/Resources/startSpinPushed.png"));
    
    Slot.SetWhiteScreenTexture(LoadTexture("src/View/LifeCycle/Resources/whiteScreen.png"));
    ...
    Slot.SetCashOutButton(LoadTexture("src/View/LifeCycle/Resources/cashOut.png"));
    
    Slot.SetCashOutButtonPushed(LoadTexture("src/View/LifeCycle/Resources/cashOutPushed.png"));
...
void LifeCycle:: PreparingTexturesView4() // View 4 Bonus Game ->
{
    ...
    ViewBonusGame.SetBackgroundBonusGame(LoadTexture("src/View/LifeCycle/Resources/backgroundBonusGame.png"));
    
    ViewBonusGame.SetRedButton(LoadTexture("src/View/LifeCycle/Resources/redButton.png"));
    
    ViewBonusGame.SetBlackButton(LoadTexture("src/View/LifeCycle/Resources/blackButton.png"));
    
    ViewBonusGame.SetCardTexture(LoadTexture("src/View/LifeCycle/Resources/cardBack.png"));
    
    ViewBonusGame.SetBlackButtonPushed(LoadTexture("src/View/LifeCycle/Resources/blackButtonPushed.png"));
    
    ViewBonusGame.SetRedButtonPushed(LoadTexture("src/View/LifeCycle/Resources/redButtonPushed.png"));
    
    ViewBonusGame.SetRedCard1(LoadTexture("src/View/LifeCycle/Resources/red1.png"));
    
    ViewBonusGame.SetRedCard2(LoadTexture("src/View/LifeCycle/Resources/red2.png"));
    
    ViewBonusGame.SetRedCard3(LoadTexture("src/View/LifeCycle/Resources/red3.png"));
    
    ViewBonusGame.SetRedCard4(LoadTexture("src/View/LifeCycle/Resources/red4.png"));
    
    ViewBonusGame.SetRedCard5(LoadTexture("src/View/LifeCycle/Resources/red5.png"));
    
    ViewBonusGame.SetBlackCard1(LoadTexture("src/View/LifeCycle/Resources/black1.png"));
    
    ViewBonusGame.SetBlackCard2(LoadTexture("src/View/LifeCycle/Resources/black2.png"));
    
    ViewBonusGame.SetBlackCard3(LoadTexture("src/View/LifeCycle/Resources/black3.png"));
    
    ViewBonusGame.SetBlackCard4(LoadTexture("src/View/LifeCycle/Resources/black4.png"));
    
    ViewBonusGame.SetBlackCard5(LoadTexture("src/View/LifeCycle/Resources/black5.png"));
    
    ViewBonusGame.SetCloseBonusGameButton(LoadTexture("src/View/LifeCycle/Resources/closeButton.png"));
...
void LifeCycle:: RefreshFromBackup(bool IsGameSaved)
{
    if(IsGameSaved == true)
    {
        ...
        creditSurface = TTF_RenderText_Solid(Xanadu, itos(m_nCredit).c_str(), color);
...
void LifeCycle:: CashOutAnimation()
{
    ...
    string finalCreditText = "Total Winnings: " + itos(gameController.GetCredits()) + " BGN";
...
void LifeCycle:: LoadMusic()
{
    ...
    startButtonSound = Mix_LoadWAV("src/View/LifeCycle/Resources/comingShip.wav");
    ...
    bonusGameMusic = Mix_LoadWAV("src/View/LifeCycle/Resources/bonusGameMusic.wav");
...
{
    if(IsRedPressed(xZ, yZ) == true && BonusGameController::GetBonusGameResult() == eBlack)
    {
    ...
    else if(IsRedPressed(xZ, xZ) == true && BonusGameController::GetBonusGameResult() == eRed)
    {
    ...
    else if(IsBlackPressed(xZ, yZ) == true && BonusGameController::GetBonusGameResult() == eRed)
    {
        selectCardText = "You Lose !";
    ...
    else if(IsBlackPressed(xZ, yZ) == true && BonusGameController::GetBonusGameResult() == eBlack)
    {
        selectCardText = "You WIN ! " + gameController.CreditsAsString();
