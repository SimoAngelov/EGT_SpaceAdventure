...
#ifndef View3_Slot_hpp
#define View3_Slot_hpp
...
private:
    ...
    SDL_Texture* cashOutButton = NULL;
    
    SDL_Texture* cashOutButtonPushed = NULL;
    
    SDL_Texture* whiteScreenTexture = NULL;
...
public:
    ...
    void SetCashOutButton(SDL_Texture* texture);
    
    void SetCashOutButtonPushed(SDL_Texture* texture);
    
    void SetWhiteScreenTexture(SDL_Texture* texture);
    ...
    SDL_Texture* GetCashOutButton();
    
    SDL_Texture* GetCashOutButtonPushed();
    
    SDL_Texture* GetWhiteScreenTexture();
    ...
    // destroying textures from view 3
