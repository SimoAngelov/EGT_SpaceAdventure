...
bool LifeCycle:: IsInsertCreditPressed(int x, int y) // Insert Credit / Start New Game
{
    ...
    {
        if(x >= Rect.rectInsertCredit.x && x <= (Rect.rectInsertCredit.x + Rect.rectInsertCredit.w) && y >= Rect.rectInsertCredit.y && y <= (Rect.rectInsertCredit.y + Rect.rectInsertCredit.h)  && StartCreditMenuEffect == false && presentSpaceShip == false && counterViewControllers == 1 && infoShown == false &&     payTableShown == false)
        {
            m_nCredit = 0;
...
bool LifeCycle:: IsLoadGamePressed(int x, int y) // Load Game Button
{
    if(ev.type == SDL_MOUSEBUTTONDOWN)
    {
        if(x >= Rect.rectLoadGame.x && x <= (Rect.rectLoadGame.x + Rect.rectLoadGame.w) && y >= Rect.rectLoadGame.y && y <= (Rect.rectLoadGame.y + Rect.rectLoadGame.h)  && StartCreditMenuEffect == false && presentSpaceShip == false && counterViewControllers == 1 && infoShown == false && payTableShown == false)
        {
...
bool LifeCycle:: IsInfoPressed(int x, int y) // Info Button
{
    if(ev.type == SDL_MOUSEBUTTONDOWN)
    {
        if(x >= Rect.rectInfoButton.x && x <= (Rect.rectInfoButton.x + Rect.rectInfoButton.w) && y >= Rect.rectInfoButton.y && y <= (Rect.rectInfoButton.y + Rect.rectInfoButton.w) && presentSpaceShip == false && payTableShown == false)
        {
            PresentView1();
...
bool LifeCycle:: IsPayTablePressed(int x, int y) // PayTable Button
{
    if(ev.type == SDL_MOUSEBUTTONDOWN)
    {
        if(x >= Rect.rectPayTableButton.x && x <= (Rect.rectPayTableButton.x + Rect.rectPayTableButton.w) && y >= Rect.rectPayTableButton.y && y <= (Rect.rectPayTableButton.y + Rect.rectPayTableButton.w) && presentSpaceShip == false && infoShown == false)
        {
            PresentView1();
...
bool LifeCycle:: IsCloseRulesPressed(int x, int y) // Close Rules Texture
{
    if(ev.type == SDL_MOUSEBUTTONDOWN)
    {
        if(x >= Rect.rectCloseRulesButton.x && x <= (Rect.rectCloseRulesButton.x + Rect.rectCloseRulesButton.w) && y >= Rect.rectCloseRulesButton.y && y <= (Rect.rectCloseRulesButton.y + Rect.rectCloseRulesButton.w) && presentSpaceShip == false && payTableShown == false)
        {
            PresentView1();
...
bool LifeCycle:: IsClosePayTablePressed(int x, int y) // Close PayTable Texture
{
    if(ev.type == SDL_MOUSEBUTTONDOWN)
    {
        if(x >= Rect.rectClosePayTableButton.x && x <= (Rect.rectClosePayTableButton.x + Rect.rectClosePayTableButton.w) && y >= Rect.rectClosePayTableButton.y && y <= (Rect.rectClosePayTableButton.y + Rect.rectClosePayTableButton.w) && presentSpaceShip == false && infoShown == false)
        {
            PresentView1();
...
bool LifeCycle:: IsForwardPressed(int x, int y) // Forward Button
{
    if(ev.type == SDL_MOUSEBUTTONDOWN)
    {
        if(x >= Rect.rectForwardButton.x && x <= (Rect.rectForwardButton.x + Rect.rectForwardButton.w) && y >= Rect.rectForwardButton.y && y <= (Rect.rectForwardButton.y + Rect.rectForwardButton.h) && presentSpaceShip == false && okPushedSpaceShip == true && counterViewControllers == 1 && infoShown == false && payTableShown == false)
        {
            PresentView1();
...
bool LifeCycle:: IsBackPressed(int x, int y)
{
    if(ev.type == SDL_MOUSEBUTTONDOWN)
    {
        if(xZ >= Rect.rectBackButton.x && xZ <= (Rect.rectBackButton.x + Rect.rectBackButton.w) && yZ >= Rect.rectBackButton.y && yZ <= (Rect.rectBackButton.y + Rect.rectBackButton.h) && counterViewControllers == 2 && infoShown == false && payTableShown == false)
        {
            okPushedSpaceShip = true;
...
bool LifeCycle:: IsPlayPressed(int x, int y)
{
    if(ev.type == SDL_MOUSEBUTTONDOWN)
    {
        if(xZ >= Rect.rectButtonPlay.x && xZ <= (Rect.rectButtonPlay.x + Rect.rectButtonPlay.w) && yZ >= Rect.rectButtonPlay.y && yZ <= (Rect.rectButtonPlay.y + Rect.rectButtonPlay.h) && counterViewControllers == 2 && infoShown == false && payTableShown == false)
        {
...
bool LifeCycle:: IsStartSpinPressed(int x, int y) // Start Spin Button
{
    if(ev.type == SDL_MOUSEBUTTONDOWN)
    {
        if(xZ >= Rect.rectStartSpinButton.x && xZ <= (Rect.rectStartSpinButton.x + Rect.rectStartSpinButton.w) && yZ >= Rect.rectStartSpinButton.y && yZ <= (Rect.rectStartSpinButton.y + Rect.rectStartSpinButton.h) && counterViewControllers == 3 && gameController.TotalBetExceedsCredits() == false && infoShown == false && payTableShown == false)
        {
...
bool LifeCycle:: IsMinusLinesPressed(int x, int y) // Minus Lines Button
{
    if(ev.type == SDL_MOUSEBUTTONDOWN)
    {
        if(xZ >= Rect.rectMinusButtonLines.x && xZ <= (Rect.rectMinusButtonLines.x + Rect.rectMinusButtonLines.w) && yZ >= Rect.rectMinusButtonLines.y && yZ <= (Rect.rectMinusButtonLines.y + Rect.rectMinusButtonLines.h) && counterViewControllers == 3 && infoShown == false && payTableShown == false)
        {
...
bool LifeCycle::IsPlusLinesPressed(int x, int y) // Plus Lines Button
{
    if(ev.type == SDL_MOUSEBUTTONDOWN)
    {
        if(xZ >= Rect.rectPlusButtonLines.x && xZ <= (Rect.rectPlusButtonLines.x + Rect.rectPlusButtonLines.w) && yZ >= Rect.rectPlusButtonLines.y && yZ <= (Rect.rectPlusButtonLines.y + Rect.rectPlusButtonLines.h) && counterViewControllers == 3 && infoShown == false && payTableShown == false)
        {
...
bool LifeCycle:: IsCashOutPressed(int x, int y) // Cash Out Button
{
    if(ev.type == SDL_MOUSEBUTTONDOWN)
    {
        if(xZ >= Rect.rectCashOutButton.x && xZ <= (Rect.rectCashOutButton.x + Rect.rectCashOutButton.w) && yZ >= Rect.rectCashOutButton.y && yZ <= (Rect.rectCashOutButton.y + Rect.rectCashOutButton.h) && counterViewControllers == 3 && infoShown == false && payTableShown == false)
        {
...
bool LifeCycle:: IsMinusBetPressed(int x, int y) // Minus Bet Button
{
    if(ev.type == SDL_MOUSEBUTTONDOWN)
    {
        if(xZ >= Rect.rectMinusBetButton.x && xZ <= (Rect.rectMinusBetButton.x + Rect.rectMinusBetButton.w) && yZ >= Rect.rectMinusBetButton.y && yZ <= (Rect.rectMinusBetButton.y + Rect.rectMinusBetButton.h) && counterViewControllers == 3 && infoShown == false && payTableShown == false)
        {
...
bool LifeCycle:: IsPlusBetPressed(int x, int y) // Plus Bet Button
{
    if(ev.type == SDL_MOUSEBUTTONDOWN)
    {
        if(xZ >= Rect.rectPlusBetButton.x && xZ <= (Rect.rectPlusBetButton.x + Rect.rectPlusBetButton.w) && yZ >= Rect.rectPlusBetButton.y && yZ <= (Rect.rectPlusBetButton.y + Rect.rectPlusBetButton.h) && counterViewControllers == 3 && infoShown == false && payTableShown == false)
        {
...
bool LifeCycle:: IsMaxBetPressed(int x, int y) // Max Bet Button
{
    if(ev.type == SDL_MOUSEBUTTONDOWN)
    {
        if(xZ >= Rect.rectMaxBetButton.x && xZ <= (Rect.rectMaxBetButton.x + Rect.rectMaxBetButton.w) && yZ >= Rect.rectMaxBetButton.y && yZ <= (Rect.rectMaxBetButton.y + Rect.rectMaxBetButton.h) && counterViewControllers == 3 && infoShown == false && payTableShown == false)
        {
