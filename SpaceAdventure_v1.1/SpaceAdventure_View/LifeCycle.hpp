...
//include for casting string to int
...
private:
	...
	// Creating object form IntroController

	IntroController introController;

	//Creating object from GameController
